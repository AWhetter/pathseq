...
import re
import sys
from typing import ClassVar, Generic, overload, TypeVar, Union
...
class BasePurePathSequence(abc.ABC, Sequence[PathT_co]):
    ...
    @overload
    def __init__(self: BasePurePathSequence[PathT_co], path: PathT_co) -> None: ...
    ...
    def with_segments(self, *pathsegments: Segment) -> Self:
        return self.__class__(self._path.__class__(*pathsegments))  # type: ignore[abstract]
